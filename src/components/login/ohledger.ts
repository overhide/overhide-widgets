  ...
  <div class="panel w3-panel w3-border w3-round-xxlarge ${e => e.isActive ? 'active' : ''}">
    ...
    <div class="w3-row w3-margin">
      <div class="w3-col s12">
        <div class="input">
          <div class="clipboard">
            <div class="clickable svg" @click="${e => e.copyToClipboard()}" :disabled="${e => !e.isKeyValid}">${clipboardIcon}</div>
            <input class="w3-input" type="text" :value="${e => e.key}" @change="${(e,c) => e.changeKey(c.event)}" @keyup="${(e,c) => e.changeKey(c.event)}">
          </div>
    ...
    <div class="w3-row w3-margin">
      <div class="w3-col s12">
        <div class="input">
          <input class="w3-button w3-green w3-wide" type="button" value="continue" @click="${e => e.continue()}" :disabled="${e => !e.isKeyValid}">
        </div>
      </div>
    </div>    
  </div>
